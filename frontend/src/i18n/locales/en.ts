export default {
  ...
  modelPlaza: {
    title: 'Model Plaza',
    subtitle: 'Compare available models, channel differences, and current billing standards by group',
    ...
    pricingTableTitle: 'Full Model Pricing Table',
    pricingTableDesc: 'Shows official pricing and your site display pricing for the groups currently available to you. The table only uses models and billing fields that already exist on this site, including input, output, cache write, cache read, plus >200K token tiers when available.',
    pricingSearchPlaceholder: 'Search by model, alias, platform, or mode',
    officialPriceCardTitle: 'Official pricing fields',
    officialPriceCardDesc: 'Displays official Input / Output / Cache Write / Cache Read prices so you can compare directly against vendor pricing docs.',
    sitePriceCardTitle: 'Displayed site pricing',
    sitePriceCardDesc: 'Each group column is calculated as “official price × group display multiplier”. If no display multiplier is configured, it falls back to the billing multiplier. Unit: site balance / MTok.',
    ...
    pricingFormula: 'Displayed site price = official price × group display multiplier. If unset, it falls back to the billing multiplier. The official column uses USD / MTok, and group columns use balance / MTok.',
    pricingResults: '{total} pricing rows total, {count} after filtering',
    pricingColModel: 'Model / Notes',
    pricingColOfficial: 'Official Price',
    officialUnitHint: 'Unit: USD / MTok',
    siteUnitHint: 'Unit: balance / MTok',
    ...
    notSupportedInGroup: 'This group does not currently show pricing for this model',
