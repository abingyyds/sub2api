export default {
  ...
  auth: {
    ...
    legal: {
      ...
      readBeforeAccept: 'Open and read before accepting',
      accepted: 'Accepted',
      commitmentLabel: 'I have read and agree to the User Agreement and Privacy Policy, and I will not use cCoder for political activities, illegal purposes, abuse, fraud, attacks, rights infringement, or other prohibited conduct.',
      acceptDocument: 'I have read and accept',
      scrollToAccept: 'Please scroll through the full document before accepting.',
      finishedReading: 'Read',
      required: 'Please read and accept the User Agreement and Privacy Policy before continuing.',
      acceptBeforeOAuth: 'Accept the legal terms first'
    },
  ...
  dashboard: {
    ...
    sourceStats7d: 'User Sources (7 Days)',
    sourceStats24h: 'User Sources (24 Hours)',
  ...
  keys: {
    ...
    importToCcSwitchApp: 'Import {app}',
    chooseCcSwitchImport: 'Choose Import',
    enable: 'Enable',
    disable: 'Disable',
    nameLabel: 'Name',
    ...
    legal: {
      ...
      description: 'Before creating or using API keys, review and accept the current User Agreement and Privacy Policy.',
      accepted: 'Accepted',
      reviewTerms: 'Review User Agreement',
      reviewPrivacy: 'Review Privacy Policy',
      commitmentLabel: 'I have read and agree to the User Agreement and Privacy Policy, and I will not use API keys for political activities, illegal purposes, abuse, fraud, attacks, rights infringement, or other prohibited conduct.',
      acceptButton: 'Accept and continue',
      acceptLabel: 'I have read and accept',
      required: 'Please review and accept the User Agreement and Privacy Policy before creating an API key.',
      success: 'Legal agreement accepted. You can now create API keys.'
    },
    usage: 'Usage',
    today: 'Today',
    total: 'Total',
    ...
    usageLimitPlaceholder: 'e.g., 10.00 (USD)',
    usageLimitHint: 'Set maximum usage limit for this API key in USD, leave empty for unlimited',
    ...
    ccsClientSelect: {
      ...
      codexCli: 'Codex CLI',
      codexCliDesc: 'Import as Codex / OpenAI-style configuration',
    },
    // Card-based creation area
    newApiKey: 'Create API Key',
    newApiKeyDesc: 'Choose the model group and rate that fits your needs, then click a card to create an API key quickly.',
    newApiKeyBillingHint: 'Billing is deducted in real time using official API token pricing. USD 1 spent officially = 1 balance consumed here. Models, channels, and effective rates vary by group, so it is worth checking the billing standard in Model Plaza first.',
    newApiKeyBillingLink: 'View billing standard in Model Plaza',
    keysManagement: 'Keys Management',
    keysCount: '{count} keys',
    ccSwitchImportHint: 'Import to CC Switch after creation',
    download: 'Download',
    create: 'Create',
    unavailable: 'Unavailable',
    groupCount: '{count} groups',
    recharge: 'Top Up',
    rechargeDesc: 'Low balance? Click to recharge',
    buyNewPlan: 'Buy New Plan',
    buyNewPlanDesc: 'View more plan options',
    groupInfo: 'Group Info',
    createKeyForGroup: 'Pre-filled based on your selected group. Confirm and submit.',
    faq: {
      title: 'Billing & Group FAQ',
      q1: 'What does "X per $1" on a group card mean?',
      a1: 'This is the group\'s exchange rate, representing how much platform balance is consumed per $1 of official model cost.<br><br>For example, "1.8 per $1" means: when the model charges $1 officially, you only consume 1.8 platform balance.',
      q2: 'How is the actual charge calculated?',
      a2: 'Actual charge = Official USD price × Group rate<br><br>Example: Claude Sonnet 4 costs $3/million input tokens. With a 1.8x rate group, the actual cost is 3 × 1.8 = 5.4 platform balance per million input tokens.',
      q3: 'What are the differences between groups? How to choose?',
      a3: 'Groups differ mainly in:<br><br>• Rate: Lower rate = lower cost<br>• Supported models: Some groups only support specific models<br>• Stability & speed: Different concurrency limits and response times<br><br>Recommendation: Use the recommended group for daily use; choose specialized groups for high stability requirements.',
      q4: 'Can I create multiple keys?',
      a4: 'Yes. Each key is bound to one group. You can create keys for different groups for different purposes (e.g., development, production). All keys share the same account balance.',
      q5: 'How are quotas deducted? What\'s the relationship between subscription and flexible quotas?',
      a5: 'When making API calls, the system first consumes subscription quota (for subscribers). When subscription quota is insufficient, it automatically switches to flexible quota (purchased on-demand).<br><br>• Subscription quota: Valid during subscription period, auto-recovers<br>• Flexible quota: Never expires, consumed until depleted',
    },
  },
  ...
  usage: {
    ...
    trueCostDetails: 'True Cost Breakdown',
    billingDetails: 'Billing Breakdown',
    billingStandard: 'Billing Standard',
    actualDeduction: 'Actual Deduction',
    inputBilled: 'Input billed',
    outputBilled: 'Output billed',
    cacheCreationBilled: 'Cache write billed',
    cacheReadBilled: 'Cache read billed',
    trueCost: 'True cost',
    accountCost: 'Account billing',
    ...
    currentSubscription: 'Current Subscription Quota',
    subscriptionFallbackName: 'Subscription #{id}',
    subscriptionBillingNote:
      'No model-specific separation. This subscription supports all site models. Claude models default to the CC special-price group, and Opus 4.7 is billed as the full-power group.',
    subscriptionStatusActive: 'Active',
    subscriptionExpiresAt: 'Expires',
    subscriptionDaysRemaining: '{days} days left ({date})',
    subscriptionNoExpiration: 'No expiration',
    subscriptionExpired: 'Expired',
    subscriptionMonthly: 'Monthly',
    subscriptionWeekly: 'Weekly',
    subscriptionDaily: 'Daily',
    subscriptionResetsIn: 'resets in {time}',
    subscriptionWindowNotActive: 'Reset timer starts after first use',
    subscriptionUnlimited: 'No quota limit configured for this subscription',
  ...
  admin: {
    ...
    groups: {
      ...
      rateMultiplierHint: 'Affects real billing. Configure price presentation separately in Card Display Settings below.',
      ...
      quotaPackage: {
        ...
        validityDays: 'Quota Validity (Days)',
        validityDaysPlaceholder: '30',
        validityDaysHint: 'Each purchase has its own expiry. Usage deducts the quota expiring soonest first.',
        validityDaysValue: '{days} days valid'
      },
      modelPlaza: {
      ...
      cardDisplay: {
        ...
        description: 'Configure display info for key-center group cards and the Model Plaza pricing table. This does not affect real billing.',
        ...
        displayRateMultiplier: 'Display Price Multiplier',
        displayRateMultiplierPlaceholder: 'Leave empty to follow billing multiplier',
        displayRateMultiplierHint: 'Used only for Model Plaza price presentation. When empty, it falls back to the billing multiplier.',
        tags: 'Tags',
        addTag: 'Add Tag',
    ...
    promo: {
      ...
      description: 'Create and manage purchase discount codes',
      ...
      discountAmount: 'Discount Value',
      discountAmountHintFixed: 'Amount in fen (100 = ¥1.00)',
      discountAmountHintPercent: 'Percentage value (10 = 10% off)',
      minOrderAmount: 'Minimum Order Amount',
      minOrderAmountHint: 'Amount in fen (0 = no minimum)',
      zeroNoLimit: '0 = no minimum',
      ...
      createFirstCode: 'Create your first promo code to offer purchase discounts.',
    ...
    inviteCodes: {
      ...
      description: 'Create and manage source-bound invite codes to track user registration sources',
      ...
      maxUsesHint: 'Code will be disabled after reaching the limit',
      notes: 'Notes',
      ...
      sources: 'Sources',
      noCodes: 'No invite codes',
      copyLink: 'Copy registration link',
      linkCopied: 'Registration link copied',
      enabled: 'Enabled',
      disabled: 'Disabled',
      createSuccess: 'Invite code created successfully',
      updateSuccess: 'Invite code updated successfully',
      deleteSuccess: 'Invite code deleted successfully',
      createFailed: 'Failed to create invite code',
      updateFailed: 'Failed to update invite code',
      deleteFailed: 'Failed to delete invite code',
      deleteConfirm: 'Are you sure you want to delete this invite code? This action cannot be undone.',
    ...
    usage: {
      ...
      billingTypeQuotaPackage: 'Quota Package',
      ipAddress: 'IP',
      cleanup: {
        button: 'Cleanup',
    ...
    orders: {
      ...
      invoiceRequestsDescription: 'Review pending invoice requests',
      orderNo: 'Order No',
      userId: 'User ID',
      orderType: 'Type',
      ...
      invoiceInfo: 'Invoice Request',
      allInvoiceStatus: 'All Invoice Status',
      invoiceNone: 'Not Requested',
      ...
      invoiceRequestedAt: 'Requested At',
      markProcessed: 'Mark Processed',
      markProcessedSuccess: 'Invoice marked as processed',
      markProcessedError: 'Failed to mark invoice as processed',
      repairOrder: 'Repair Order',
      repairConfirm: 'Repair order {orderNo}? This will immediately fulfill the recharge or subscription.',
      repairSuccess: 'Order repaired and fulfilled successfully',
      repairError: 'Failed to repair order',
      allStatus: 'All Status',
      allTypes: 'All Types',
      typeSubscription: 'Subscription',
      typeQuotaPackage: 'Quota Package',
    ...
    organizations: {
      ...
      deleteConfirm: 'Are you sure you want to delete organization "{name}"?',
      name: 'Name',
      slug: 'Slug',
      ...
      updateBalanceTitle: 'Update Organization Balance',
      currentBalance: 'Current Balance',
      balanceAction: 'Action',
      balanceAdd: 'Add to Balance',
    ...
    settings: {
      ...
      registration: {
        ...
        promoCodeHint: 'Allow users to use promo codes for purchase discounts',
      ...
      defaults: {
        ...
        initialBalanceExpiryDays: 'Initial Balance Expiry (Days)',
        initialBalanceExpiryDaysHint: 'Number of days the initial balance is valid for new users, 0 means never expires',
      ...
      payment: {
        ...
        mchId: 'Merchant ID',
        key: 'Key',
        mchSerialNo: 'Merchant Certificate Serial No.',
        publicKeyId: 'WeChat Pay Public Key ID (for callback verification)',
        ...
        rechargePlansHint: 'Configure recharge tiers that users can see on the recharge page',
        addRechargePlan: 'Add Tier',
        noRechargePlans: 'No recharge tiers configured. Click the button above to add one.',
        rpName: 'Tier Name',
        rpNamePlaceholder: 'e.g. Starter',
        rpKey: 'Unique Key',
        rpKeyPlaceholder: 'e.g. starter',
        rpPayAmount: 'Pay Amount (CNY)',
        rpBalanceAmount: 'Credit Amount (USD)',
  ...
  modelPlaza: {
    title: 'Model Plaza',
    subtitle: 'Browse models by group, click to copy, and view pricing instantly',
    pricingStandardBadge: 'Billing Standard',
    pricingStandardTitle: 'Your balance is billed in real time against official USD pricing',
    pricingStandardDesc: 'You buy universal balance in RMB, and calls are deducted in real time using official API token pricing. USD 1 of official consumption = 1 balance consumed here. The same balance can be used across platforms and groups, but different channels and group rules change the effective amount of usable USD. Larger packages are usually more cost-effective.',
    pricingNoticeOfficialTitle: 'Official real-time billing',
    pricingNoticeOfficial: 'Every call is settled against the official token price of the corresponding model, so costs vary by model.',
    pricingNoticeSharedTitle: 'Shared balance across the site',
    pricingNoticeShared: 'Your topped-up balance can be used across platforms, but different groups have different channels and display rules, so effective usable USD will vary.',
    pricingNoticeVolumeTitle: 'Choose by workload',
    pricingNoticeVolume: 'For daily usage, start with the most cost-effective group. If you need stronger stability, official channels, or specific capabilities, choose the corresponding channel.',
    ...
    pricingMultiplierIncluded: 'Site price is converted using the current group rules',
    ...
    officialPriceCardTitle: 'Official pricing fields',
    officialPriceCardDesc: 'Official list price showing Input and Output, plus Cache Write / Cache Read when the model supports caching, in USD / MTok.',
    sitePriceCardTitle: 'Displayed site pricing',
    sitePriceCardDesc: 'Each group price is shown using the current display rules, including cache pricing when available. Unit: site balance / MTok.',
    groupAvailable: 'Available',
    tierPriceCardTitle: 'Large-context tiers',
    tierPriceCardDesc: 'If a model has separate >200K token pricing, that higher tier is shown in the same cell as an extra block.',
    tablePlatform: 'Platform',
    tableGroup: 'Group / Channel',
    tablePrice: 'Displayed Price',
    tableDiscount: 'Discount / Display',
    tableBillingType: 'Billing Type',
    tableModels: 'Model Coverage',
    tableNotes: 'Notes',
    modelsCount: '{count} models',
    standardRate: 'Standard rate',
    noDescription: 'No additional notes',
    pricingFormula: 'The official column uses USD / MTok, group columns use balance / MTok, and displayed site prices are recalculated from the current group display rules.',
    pricingAvailableOnly: 'Only groups with pricing are shown',
    pricingCompactHint: 'Cache pricing follows the same display rules, and unsupported groups no longer take up space.',
    pricingExplorerStats: '{groups} groups, {models} models shown',
    pricingResults: '{total} pricing rows total, {count} after filtering',
    pricingGroupsCount: '{count} available groups',
    pricingColModel: 'Model',
    pricingColOfficial: 'Official Base Price',
    pricingSupportedGroupsTitle: 'Available Group Prices',
    pricingSupportedGroupsCount: '{count} groups',
    pricingPanelTitle: 'Price Details',
    pricingPanelCopiedHint: 'The model name has been copied automatically.',
    pricingPanelEmptyTitle: 'Choose a model',
    pricingPanelEmptyDesc: 'Pick any model on the left to show the official price and the current group price here.',
    pricingCurrentGroup: 'Current Group',
    pricingMatchedModelLabel: 'Billing Model',
    pricingCompareTitle: 'Price Comparison',
    pricingCompareDesc: 'Compare the official and site pricing side by side for the same model.',
    pricingCompareRange: 'Official vs Site',
    pricingCompareMetricLabel: 'Metric',
    pricingCompareOfficialShort: 'Official',
    pricingCompareSiteShort: 'Site',
    officialUnitHint: 'Unit: USD / MTok',
    siteUnitHint: 'Unit: RMB / MTok',
    promptCachingSupported: 'Prompt cache',
    promptCachingUnsupported: 'No cache',
    aliasesLabel: 'Available aliases',
    maxInputTokens: 'Max input {count}',
    maxOutputTokens: 'Max output {count}',
    upTo200k: '≤ 200K Tokens',
    over200k: '> 200K Tokens',
    metricInput: 'Input',
    metricOutput: 'Output',
    metricCacheWrite: 'Cache write',
    metricCacheRead: 'Cache read',
    notSupportedInGroup: 'No price shown',
    noPricingRows: 'No model pricing data available to display',
    pricingTableFootnote: 'Pricing data comes from the site’s existing model configuration plus official pricing fields. Displayed group prices change automatically with the configured display rules, channel, and model mapping.',
    groupListTitle: 'Available Groups',
    groupListDesc: 'The cards below show model coverage and channel details for each group. Click a model name to copy it quickly.',
  ...
  pricing: {
    ...
    repurchaseRuleTag: 'Purchase Rules',
    repurchaseRule: 'Subscription plans cannot be repurchased while active; quota packages can be repurchased and stacked',
    ...
    promoCodeMaxUsed: 'This promo code has reached its usage limit',
    promoCodeAlreadyUsed: 'You have already used this promo code',
    promoCodeMinOrder: 'Order amount must be at least ¥{amount} to use this code',
    ...
    faq: {
      ...
      a1: 'Quotas on this site are denominated in USD and follow the official pay-as-you-go billing standard.\nUsage is deducted in real time based on official Claude API token pricing, which varies by model. See the billing standard for details.\nThe "monthly quota" included in plans resets automatically every 30 days on the subscription cycle.',
      ...
      q5: 'Plan Changes',
      a5: 'Plans take effect immediately upon purchase, with validity starting from the purchase date.\nThe same plan cannot be purchased again while it is still active; you can buy it again after expiry.\nAfter a plan expires, the subscription quota no longer resets on the subscription cycle, but remaining flexible balance is still usable.',
      q6: 'Subscription Quota vs. Flexible Balance',
      a6: 'Subscription quota: Provided with plans, resets every 30 days, and expires with the plan.\nFlexible balance: One-time top-up, never expires until fully used, billed by actual usage.\nBoth can be used simultaneously — the system prioritizes subscription quota, and any excess is deducted from flexible balance.'
    },
    plans: {
    ...
    payment: {
      ...
      quotaPackageSuccess: 'Payment successful! Quota package added',
      ...
      quotaPackageSuccessToast: 'Payment successful. Your quota package has been stacked and the page has been refreshed.',
  ...
  orderHistory: {
    ...
    invoiceConsumptionTitle: 'Invoiceable Total Consumption',
    invoiceableAmount: 'Invoiceable Consumption',
    invoiceAutoInclude: 'Submitting will automatically include all current paid consumption records that have not been invoiced.',
    invoiceReady: 'Invoice threshold reached',
    invoiceThresholdHint: 'Invoice requests require uninvoiced consumption totaling at least ¥{amount}.',
    invoiceThresholdRemaining: '¥{amount} more needed',
    invoiceThresholdError: 'Uninvoiced consumption must total at least ¥{amount} to request an invoice',
    invoiceStatus: 'Invoice Status',
  ...
  tutorial: {
    ...
    configExport: {
      ...
      importToCcSwitch: 'Import to CC Switch',
      importToCcSwitchApp: 'Import {app} to CC Switch',
      ...
      ccSwitchUnsupported: 'The selected API key group cannot be imported into this CC Switch client yet. Please switch the group or choose another client.',
      ccSwitchClientSelect: {
        title: 'Choose Client',
        description: 'This API key can be imported into multiple CC Switch clients. Choose the target client you want to launch.',
        claudeCode: 'Claude Code',
        claudeCodeDesc: 'Import as Claude Code or Claude-style client configuration',
        geminiCli: 'Gemini CLI',
        geminiCliDesc: 'Import as Gemini CLI or Gemini-style client configuration',
        codexCli: 'Codex CLI',
        codexCliDesc: 'Import as Codex or OpenAI-style client configuration',
      },
      noKeys: 'No API Keys',
  ...
  agent: {
    ...
    applyContact: 'Contact (Phone/WeChat)',
    applyContactPlaceholder: 'Enter your phone number or WeChat ID',
    applySocial: 'Social Account',
    applySocialPlaceholder: 'Your social media account (Twitter, Telegram, etc.)',
    applyPromotion: 'Promotion Plan',
    applyPromotionPlaceholder: 'Briefly describe how you plan to promote',
    applyNow: 'Apply Now',
    applying: 'Applying...',
  ...
  org: {
    ...
    members: {
      ...
      deleteConfirm: 'Are you sure you want to remove member "{email}"?',
      name: 'Name',
      email: 'Email',
      password: 'Password',
      username: 'Username',
    ...
    projects: {
      ...
      budgetPlaceholder: 'Leave empty for unlimited',
    ...
    audit: {
      ...
      unflaggedOnly: 'Unflagged Only',
      actionApiRequest: 'API Request',
      actionMemberCreate: 'Member Created',
      actionMemberUpdate: 'Member Updated',
      actionMemberDelete: 'Member Deleted',
      actionPolicyUpdate: 'Policy Updated',
      config: 'Audit Config',
      configTitle: 'Audit Configuration',
      configUpdateSuccess: 'Audit config updated successfully',
      modeMetadata: 'Metadata Only',
      modeSummary: 'Summary + Keywords',
      modeFull: 'Full Content',
      modeHint: 'Controls the depth of audit log recording'
    }
  },
