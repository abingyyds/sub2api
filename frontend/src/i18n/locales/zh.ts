export default {
  ...
  modelPlaza: {
    title: '模型广场',
    subtitle: '查看各分组可用模型、渠道差异与当前计费标准',
    ...
    pricingTableTitle: '完整版模型价格表',
    pricingTableDesc: '按你当前可用分组展示官方价与本站展示价。表内仅使用本站已有模型和官方计费字段，包含输入、输出、缓存写入、缓存读取，以及部分模型的 >200K Tokens 分档价格。',
    pricingSearchPlaceholder: '搜索模型名、别名、平台或模式',
    officialPriceCardTitle: '官方价格字段',
    officialPriceCardDesc: '展示官方 Input / Output / Cache Write / Cache Read 单价，便于直接对照官方文档。',
    sitePriceCardTitle: '本站展示价格',
    sitePriceCardDesc: '每个分组列按“官方价 × 当前分组展示倍率”换算；若未单独设置展示倍率，则自动跟随计费倍率。单位为站内余额 / MTok。',
    ...
    pricingFormula: '本站展示价 = 官方价 × 当前分组展示倍率；未单独设置时自动跟随计费倍率。官方列单位为 USD / MTok，分组列单位为余额 / MTok。',
    pricingResults: '共 {total} 条模型价格，当前筛选后 {count} 条',
    pricingColModel: '模型 / 能力说明',
    pricingColOfficial: '官方价格',
    officialUnitHint: '单位：USD / MTok',
    siteUnitHint: '单位：余额 / MTok',
    ...
    notSupportedInGroup: '该分组当前未展示此模型价格',
