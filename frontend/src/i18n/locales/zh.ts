export default {
  ...
  auth: {
    ...
    legal: {
      ...
      userAgreement: '用户协议',
      privacyPolicy: '隐私政策',
      readBeforeAccept: '打开并阅读后才能同意',
      accepted: '已同意',
      commitmentLabel: '我已阅读并同意用户协议和隐私政策，并承诺不会将 cCoder 用于政治活动、非法用途、滥用、欺诈、攻击、侵权或其他被禁止的行为。',
      acceptDocument: '我已阅读并同意',
      scrollToAccept: '请先滚动阅读完整文档后再同意。',
      finishedReading: '已读完',
      required: '请先阅读并同意用户协议和隐私政策后再继续。',
      acceptBeforeOAuth: '请先同意法律条款'
    },
  ...
  dashboard: {
    ...
    cache: '缓存',
    recentUsage: '最近使用',
    sourceStats7d: '用户来源（近 7 天）',
    sourceStats24h: '用户来源（近 24 小时）',
    last7Days: '近 7 天',
  ...
  keys: {
    ...
    importToCcSwitchApp: '导入 {app}',
    chooseCcSwitchImport: '选择导入',
    enable: '启用',
    disable: '禁用',
    nameLabel: '名称',
    ...
    legal: {
      title: '需要同意法律协议',
      description: '创建或使用 API Key 前，请先阅读并同意当前用户协议和隐私政策。',
      accepted: '已同意',
      reviewTerms: '阅读用户协议',
      reviewPrivacy: '阅读隐私政策',
      commitmentLabel: '我已阅读并同意用户协议和隐私政策，并承诺不会将 API Key 用于政治活动、非法用途、滥用、欺诈、攻击、侵权或其他被禁止的行为。',
      acceptButton: '同意并继续',
      acceptLabel: '我已阅读并同意',
      required: '请先阅读并同意用户协议和隐私政策，然后再创建 API Key。',
      success: '法律协议已同意，现在可以创建 API Key。'
    },
    usage: '用量',
    today: '今日',
    total: '累计',
    ...
    ipRestriction: 'IP 限制',
    usageLimitLabel: '用量上限',
    usageLimitPlaceholder: '例如：10.00（美元）',
    usageLimitHint: '设置此 API Key 的最大使用额度（美元），留空表示无限制',
    ipWhitelist: 'IP 白名单',
    ...
    ccsClientSelect: {
      ...
      codexCli: 'Codex CLI',
      codexCliDesc: '导入为 Codex / OpenAI 风格配置',
    },
    // 卡片式创建区域
    newApiKey: '新建 API Key',
    newApiKeyDesc: '选择适合你的模型分组与费率，点击卡片即可快速创建 API Key。',
    newApiKeyBillingHint: '本站按 API 官方 Token 价格实时扣费，官方消费 1 美元 = 本站消耗 1 余额。不同分组支持的模型、渠道与费率不同，建议先查看模型广场中的计费标准。',
    newApiKeyBillingLink: '前往模型广场查看计费标准',
    keysManagement: 'Keys 管理',
    keysCount: '共 {count} 个',
    ccSwitchImportHint: '创建后可一键导入到 CC Switch',
    download: '下载',
    create: '创建',
    unavailable: '暂不可用',
    groupCount: '{count} 个分组',
    recharge: '充值',
    rechargeDesc: '余额不足？点击充值',
    buyNewPlan: '购买新套餐',
    buyNewPlanDesc: '查看更多套餐方案',
    groupInfo: '分组信息',
    createKeyForGroup: '已根据你点击的分组创建，确认信息后提交',
    faq: {
      title: '计费与分组常见问题',
      q1: '分组卡片上的「X 块 / 1 美元」是什么意思？',
      a1: '这是该分组的汇率，代表每消耗 1 美元官方额度，需要花费多少平台余额。<br><br>例如「1.8 块 / 1 美元」表示：模型官方收费 $1 时，您只需消耗 1.8 平台余额（折合 ¥1.8）。而真实汇率约 7.2，相当于打了 2.5 折。',
      q2: '实际扣费怎么计算？',
      a2: '实际扣费 = 模型官方美元价格 × 分组汇率<br><br>举个例子：Claude Sonnet 4 官方价格为 $3 / 百万输入 Token，您选择汇率 1.8 的分组，则实际消耗 3 × 1.8 = 5.4 平台余额（折合 ¥5.4 / 百万输入 Token）。',
      q3: '不同分组有什么区别？该怎么选？',
      a3: '不同分组的主要差异在于：<br><br>• 汇率不同：汇率越低，使用成本越低<br>• 支持的模型不同：部分分组可能仅支持特定模型<br>• 稳定性和速度：不同分组可能有不同的并发限制和响应速度<br><br>一般建议：日常使用选推荐分组，对稳定性有高要求可选专用型分组。',
      q4: '可以创建多个 Key 吗？',
      a4: '可以。每个 Key 绑定一个分组，您可以为不同用途（如开发、生产）创建不同分组的 Key。所有 Key 共享同一个账户余额。',
      q5: '额度是怎么扣的？套餐额度和灵活额度有什么关系？',
      a5: 'API 调用时，系统优先消耗套餐额度（订阅用户），套餐额度不足时自动切换消耗灵活额度（按量购买所得）。<br><br>• 套餐额度：订阅期内有效，可自动恢复<br>• 灵活额度：永久有效，用完即止',
    },
  },
  ...
  usage: {
    ...
    costDetails: '成本明细',
    trueCostDetails: '真实成本明细',
    billingDetails: '计费明细',
    billingStandard: '计费标准',
    actualDeduction: '实际扣费',
    inputBilled: '输入计费',
    outputBilled: '输出计费',
    cacheCreationBilled: '缓存写入计费',
    cacheReadBilled: '缓存读取计费',
    trueCost: '真实成本',
    accountCost: '账号计费',
    ...
    avgDuration: '平均耗时',
    currentSubscription: '当前订阅额度',
    subscriptionFallbackName: '订阅 #{id}',
    subscriptionBillingNote: '不对模型进行区分，支持本站全部大模型。Claude 模型默认按 CC 特价型分组计费，Opus 4.7 按满血分组计费。',
    subscriptionStatusActive: '有效',
    subscriptionExpiresAt: '到期时间',
    subscriptionDaysRemaining: '剩余{days}天（{date}）',
    subscriptionNoExpiration: '无到期时间',
    subscriptionExpired: '已过期',
    subscriptionMonthly: '每月',
    subscriptionWeekly: '每周',
    subscriptionDaily: '每日',
    subscriptionResetsIn: '{time}后重置',
    subscriptionWindowNotActive: '首次使用后开始计算重置时间',
    subscriptionUnlimited: '该订阅未配置额度上限',
  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        ...
        rateMultiplierLabel: '计费倍率',
        rateMultiplierHint: '影响实际扣费；价格展示请在下方“卡片展示设置”里单独配置',
        exclusiveLabel: '专属分组',
      ...
      quotaPackage: {
        ...
        validityDays: '额度有效期（天）',
        validityDaysPlaceholder: '30',
        validityDaysHint: '每次购买独立计算到期时间，消耗时优先扣即将到期的额度。',
        validityDaysValue: '{days} 天有效'
      },
      modelPlaza: {
      ...
      cardDisplay: {
        title: '卡片展示设置',
        description: '配置密钥中心分组卡片与模型广场价格表的展示信息，不影响实际扣费',
        displayPrice: '展示价格',
        displayPricePlaceholder: '例如：6 块 / 1 美元',
        displayDiscount: '展示折扣',
        displayDiscountPlaceholder: '例如：8.3折',
        displayRateMultiplier: '价格展示倍率',
        displayRateMultiplierPlaceholder: '留空则跟随计费倍率',
        displayRateMultiplierHint: '仅用于模型广场价格展示换算；留空时自动回退到计费倍率',
        tags: '标签',
        addTag: '添加标签',
    ...
    promo: {
      ...
      discountType: '折扣类型',
      typeFixed: '固定金额减免',
      typePercentage: '百分比折扣',
      discountAmount: '折扣值',
      discountAmountHintFixed: '金额单位：分（100 = ¥1.00）',
      discountAmountHintPercent: '百分比值（10 = 打9折）',
      minOrderAmount: '最低消费门槛',
      minOrderAmountHint: '金额单位：分（0 = 无门槛）',
      zeroNoLimit: '0 = 无门槛',
      noMinOrder: '无门槛',
      maxUses: '最大使用次数',
      zeroUnlimited: '0 = 无限制',
      ...
      // 消息
      noCodesYet: '暂无优惠码',
      createFirstCode: '创建您的第一个优惠码，为用户提供购买折扣。',
      codeCreated: '优惠码创建成功',
      codeUpdated: '优惠码更新成功',
      codeDeleted: '优惠码删除成功',
      deleteCodeConfirm: '确定要删除此优惠码吗？此操作无法撤销。',
      copyCode: '复制优惠码',
      codeCopied: '优惠码已复制到剪贴板',
    ...
    inviteCodes: {
      title: '邀请码管理',
      description: '创建和管理来源绑定的邀请码，用于追踪用户注册来源',
      create: '创建邀请码',
      edit: '编辑邀请码',
      code: '邀请码',
      inviteLink: '邀请链接',
      ...
      usedCount: '已使用',
      maxUses: '最大使用次数',
      maxUsesPlaceholder: '留空表示无限制',
      maxUsesHint: '达到上限后邀请码将自动失效',
      notes: '备注',
      notesPlaceholder: '可选备注信息',
      totalCodes: '邀请码总数',
      activeCodes: '启用中',
      ...
      updateSuccess: '邀请码更新成功',
      deleteSuccess: '邀请码删除成功',
      createFailed: '创建邀请码失败',
      updateFailed: '更新邀请码失败',
      deleteFailed: '删除邀请码失败',
      deleteConfirm: '确定要删除此邀请码吗？此操作不可撤销。',
      loadFailed: '加载邀请码失败'
    },
    ...
    orders: {
      ...
      invoiceRequestsTitle: '开票申请',
      invoiceRequestsDescription: '查看待处理开票申请',
      orderNo: '订单号',
      userId: '用户 ID',
      orderType: '订单类型',
      sourceSite: '来源站点',
      ...
      invoiceStatus: '开票状态',
      invoiceInfo: '开票申请',
      allInvoiceStatus: '全部开票状态',
      invoiceNone: '未申请',
      invoicePending: '待处理',
      invoiceProcessed: '已处理',
      invoiceCompanyName: '抬头',
      invoiceTaxId: '税号',
      invoiceEmail: '邮箱',
      invoiceRemark: '备注',
      invoiceRequestedAt: '申请时间',
      markProcessed: '标记已处理',
      markProcessedSuccess: '已标记为处理完成',
      markProcessedError: '标记处理失败',
      repairOrder: '补单',
      repairConfirm: '确认补单订单 {orderNo} 吗？该操作会直接发放充值余额或订阅。',
      repairSuccess: '补单成功，已重新发放订单权益',
      repairError: '补单失败',
      allStatus: '全部状态',
      allTypes: '全部类型',
      typeSubscription: '订阅',
      typeQuotaPackage: '额度包',
      typeBalance: '充值',
      statusPending: '待支付',
      statusPaid: '已支付',
      statusClosed: '已关闭',
    ...
    settings: {
      ...
      registration: {
        ...
        promoCode: '优惠码',
        promoCodeHint: '允许用户在购买时使用优惠码享受折扣',
        passwordReset: '忘记密码',
      ...
      defaults: {
        ...
        initialBalanceExpiryDays: '初始余额有效期（天）',
        initialBalanceExpiryDaysHint: '新用户初始余额的有效天数，0 表示永不过期',
      ...
      payment: {
        ...
        rechargePlansHint: '配置充值优惠档位，用户可在充值页面看到这些预设套餐',
        addRechargePlan: '添加档位',
        noRechargePlans: '暂未配置充值档位，点击上方按钮添加',
        rpName: '档位名称',
        rpNamePlaceholder: '如：入门档',
        rpKey: '唯一标识',
        rpKeyPlaceholder: '如：starter',
        rpPayAmount: '实付金额（元）',
        rpBalanceAmount: '到账余额（美元）',
        rpDescription: '描述',
  ...
  modelPlaza: {
    title: '模型广场',
    subtitle: '按分组浏览模型，点击即可复制并查看价格',
    pricingStandardBadge: '模型计费标准',
    pricingStandardTitle: '本站余额按官方美金价格实时扣费',
    pricingStandardDesc: '本站以人民币购买通用余额，调用时按 API 官方 Token 价格实时扣费。官方消费 1 美元 = 本站消耗 1 余额；同一余额可在不同平台与分组通用，但因渠道与分组规则不同，折算后的可用美金额度会不同，通常套餐越大越划算。',
    pricingNoticeOfficialTitle: '官方实时扣费',
    pricingNoticeOfficial: '所有调用按对应模型的官方 Token 单价实时结算，不同模型成本不同。',
    pricingNoticeSharedTitle: '余额全站通用',
    pricingNoticeShared: '充值后的余额可跨平台使用，但不同分组的渠道和展示规则不同，等效可用美金额度也会不同。',
    pricingNoticeVolumeTitle: '按场景选分组',
    pricingNoticeVolume: '日常使用可优先选择更高性价比的分组；若更看重稳定性、官渠或特定能力，可选择对应渠道。',
    pricingExplorerTitle: '分组模型价格',
    pricingExplorerDesc: '左侧看分组和模型，右侧固定显示当前选中模型的官方价和本站价。',
    pricingSelectionHint: '点击左侧模型后，右侧价格卡会立即切换。',
    pricingMultiplierIncluded: '本站价格已按当前分组规则换算',
    pricingTableTitle: '模型价格',
    pricingTableDesc: '只展示官方基础价和当前可用分组价，未支持的分组不再占位。',
    pricingSearchPlaceholder: '搜索模型名、别名、平台或模式',
    officialPriceCardTitle: '官方价格字段',
    officialPriceCardDesc: '官方原价，展示 Input / Output；若模型支持缓存，也展示 Cache Write / Cache Read。单位 USD / MTok。',
    sitePriceCardTitle: '本站展示价格',
    sitePriceCardDesc: '各分组价格按当前展示规则换算后展示，缓存价也按相同规则计算。单位为站内余额 / MTok。',
    groupAvailable: '当前可用',
    tierPriceCardTitle: '大上下文分档',
    tierPriceCardDesc: '若模型存在 >200K Tokens 单独定价，会在同一单元格中额外展示对应分档价格。',
    tablePlatform: '平台',
    tableGroup: '分组 / 渠道',
    tablePrice: '展示价格',
    tableDiscount: '折扣 / 展示',
    tableBillingType: '计费方式',
    tableModels: '模型范围',
    tableNotes: '适用说明',
    modelsCount: '{count} 个模型',
    standardRate: '标准费率',
    noDescription: '暂无额外说明',
    pricingFormula: '官方列单位为 USD / MTok，分组列单位为余额 / MTok；本站展示价按当前分组展示规则实时换算。',
    pricingAvailableOnly: '仅显示有价格的分组',
    pricingCompactHint: '缓存价按相同规则换算，未支持的分组不再单独占位。',
    pricingExplorerStats: '当前展示 {groups} 个分组，{models} 个模型',
    pricingResults: '共 {total} 条模型价格，当前筛选后 {count} 条',
    pricingGroupsCount: '{count} 个可用分组',
    pricingColModel: '模型',
    pricingColOfficial: '官方基础价',
    pricingSupportedGroupsTitle: '可用分组价',
    pricingSupportedGroupsCount: '{count} 个分组',
    pricingPanelTitle: '价格详情',
    pricingPanelCopiedHint: '模型名已自动复制。',
    pricingPanelEmptyTitle: '选择一个模型',
    pricingPanelEmptyDesc: '点击左侧任意模型后，这里会显示官方价格和当前分组价格。',
    pricingCurrentGroup: '当前分组',
    pricingMatchedModelLabel: '计价模型',
    pricingCompareTitle: '价格对比',
    pricingCompareDesc: '同一模型按项对照官方价和本站价。',
    pricingCompareRange: '官方 vs 本站',
    pricingCompareMetricLabel: '项目',
    pricingCompareOfficialShort: '官方',
    pricingCompareSiteShort: '本站',
    officialUnitHint: '单位：USD / MTok',
    siteUnitHint: '单位：RMB / MTok',
    promptCachingSupported: '支持缓存',
    promptCachingUnsupported: '不支持缓存',
    aliasesLabel: '可用别名',
    maxInputTokens: '最大输入 {count}',
    ...
    notSupportedInGroup: '暂无价格',
    noPricingRows: '暂无可展示的模型价格数据',
    pricingTableFootnote: '价格数据来自本站现有模型配置与官方价格字段；分组展示价格会随展示规则、渠道和模型映射实时变化。',
    groupListTitle: '当前可用分组',
    groupListDesc: '下方卡片展示各分组的模型覆盖范围与渠道信息，点击模型名可快速复制。',
    empty: '暂无可用分组',
  ...
  pricing: {
    ...
    repurchaseRuleTag: '购买规则',
    repurchaseRule: '订阅套餐有效期内不可重复购买；额度包可重复购买并叠加额度',
    wechatPay: '微信扫码支付',
    noPlans: '暂无可用套餐',
    howToBuy: '购买方式',
    ...
    promoCodeMaxUsed: '此优惠码已达到使用上限',
    promoCodeAlreadyUsed: '您已使用过此优惠码',
    promoCodeMinOrder: '订单金额不满 ¥{amount}，不可使用此优惠码',
    promoDiscountFixed: '优惠 ¥{amount}',
    promoDiscountPercent: '打 {percent} 折，优惠 ¥{amount}',
    ...
    faq: {
      title: '常见问题',
      q1: '额度与计费规则',
      a1: '本站额度单位为美元，与官方按量计费标准一致。\n按 Claude API 官方 Token 价格实时扣费，不同模型价格不同。详情请见计费标准。\n套餐内含的「每月额度」按订阅周期每30天自动重置。',
      q2: '灵活额度说明',
      a2: '灵活额度是一次性充值的余额，按实际使用量扣费。\n没有有效期限制，用完为止。\n适合用量不固定、偶尔使用的用户。',
      q3: '如何升级套餐？',
      a3: '每个账号的同一套餐需在当前订阅到期后再次购买。\n如需调整套餐，可按实际需求选择其他套餐分组。\n无需手动取消，当前套餐到期后会自动失效。',
      q4: '额度恢复机制',
      a4: '套餐订阅额度按订阅周期每30天自动重置。\n灵活额度不会重置，用完需重新充值。\n如果当期额度用完，可以通过充值灵活额度继续使用。',
      q5: '套餐变更说明',
      a5: '套餐购买后立即生效，有效期从购买日起计算。\n同一套餐在有效期内不可重复购买，到期后可再次购买。\n套餐到期后停止按订阅周期重置订阅额度，剩余灵活额度仍可使用。',
      q6: '订阅额度与灵活额度有什么区别？',
      a6: '订阅额度：随套餐提供，每30天自动重置，套餐到期后失效。\n灵活额度：一次性充值，永久有效直到用完，按实际使用扣费。\n两者可同时使用，系统优先消耗订阅额度，超出部分从灵活额度扣除。'
    },
    payment: {
      scanToPay: '微信扫码支付',
      amount: '支付金额',
      ...
      quotaPackageSuccess: '支付成功！额度包已到账',
      rechargeSuccess: '充值成功！余额已到账',
      paymentSuccessToast: '支付成功，订阅已激活，页面已自动刷新',
      quotaPackageSuccessToast: '支付成功，额度包已叠加到账，页面已自动刷新',
      ...
      subscriptionRepurchaseBlocked: '每个账号的同一套餐在有效期内只能购买一次，请在当前套餐到期后再购买。',
  ...
  orderHistory: {
    ...
    invoiceConsumptionTitle: '可开票总消费',
    invoiceableAmount: '可开票消费金额',
    invoiceAutoInclude: '提交后将自动合并当前所有未开票的已支付消费记录。',
    invoiceReady: '已满足开票金额要求',
    invoiceThresholdHint: '累计未开票消费满 ¥{amount} 才可提交开票申请。',
    invoiceThresholdRemaining: '还差 ¥{amount} 可开票',
    invoiceThresholdError: '累计未开票消费满 ¥{amount} 才可以开票',
    invoiceStatus: '开票状态',
  ...
  tutorial: {
    ...
    configExport: {
      ...
      importToCcSwitchApp: '一键导入 {app} 到 CC Switch',
      ...
      ccSwitchUnsupported: '当前所选 API Key 分组暂不支持导入到这个 CC Switch 客户端，请更换分组或选择其他客户端。',
      ccSwitchClientSelect: {
        title: '选择导入客户端',
        description: '这个 API Key 支持多个 CC Switch 客户端，请选择你想一键导入的目标客户端。',
        claudeCode: 'Claude Code',
        claudeCodeDesc: '导入 Claude Code / Claude 风格客户端配置',
        geminiCli: 'Gemini CLI',
        geminiCliDesc: '导入 Gemini CLI / Gemini 风格客户端配置',
        codexCli: 'Codex CLI',
        codexCliDesc: '导入 Codex / OpenAI 风格客户端配置',
      },
      noKeys: '暂无 API Key',
  ...
  agent: {
    ...
    applyContact: '联系方式（手机/微信）',
    applyContactPlaceholder: '请输入手机号或微信号',
    applySocial: '社交账号',
    applySocialPlaceholder: '您的社交媒体账号（Twitter、Telegram 等）',
    applyPromotion: '推广计划',
    applyPromotionPlaceholder: '请简要说明您的推广计划',
    applyNow: '立即申请',
    applying: '申请中...',
  ...
  org: {
    ...
    members: {
      ...
      roleMember: '成员',
      dailyQuota: '日限额 (USD)',
      monthlyQuota: '月限额 (USD)',
      dailyUsage: '日用量',
      monthlyUsage: '月用量',
      quotaUnlimited: '无限',
      notes: '备注',
      suspend: '停用',
      suspendSuccess: '成员已停用'
    },
    projects: {
      title: '项目管理',
      description: '管理企业项目',
    ...
    audit: {
      ...
      flaggedOnly: '仅已标记',
      unflaggedOnly: '仅未标记',
      actionApiRequest: 'API 请求',
      actionMemberCreate: '创建成员',
      actionMemberUpdate: '更新成员',
      actionMemberDelete: '删除成员',
      actionPolicyUpdate: '更新策略',
      config: '配置',
      configTitle: '审计配置',
      configUpdateSuccess: '审计配置更新成功',
      modeMetadata: '仅元数据',
      modeSummary: '摘要模式',
      modeFull: '完整模式',
      modeHint: '元数据：仅记录模型、Token、费用；摘要：记录前200字符+关键词；完整：记录完整请求和响应'
    }
  },
