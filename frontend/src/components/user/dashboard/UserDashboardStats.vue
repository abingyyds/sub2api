        ...
        <div class="rounded-2xl border-2 border-gray-200 bg-white dark:border-dark-700 dark:bg-dark-900 shadow-soft p-4">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xl font-bold text-emerald-600 dark:text-emerald-400">$<AnimatedNumber :value="balance" :decimals="2" /></p>
        ...
        <div class="rounded-2xl border-2 border-gray-200 bg-white dark:border-dark-700 dark:bg-dark-900 shadow-soft p-4">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xl font-bold text-gray-900 dark:text-white"><AnimatedNumber :value="stats?.total_api_keys || 0" /></p>
              <p class="text-xs text-green-600 dark:text-green-400"><AnimatedNumber :value="stats?.active_api_keys || 0" /> {{ t('common.active') }}</p>
            </div>
          </div>
        </div>
      </GlowCard>
        ...
        <div class="rounded-2xl border-2 border-gray-200 bg-white dark:border-dark-700 dark:bg-dark-900 shadow-soft p-4">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xl font-bold text-gray-900 dark:text-white"><AnimatedNumber :value="stats?.today_requests || 0" /></p>
          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xl font-bold text-gray-900 dark:text-white">
                <span class="text-purple-600 dark:text-purple-400" :title="t('usage.actualDeduction')">${{ formatCost(stats?.today_actual_cost || 0) }}</span>
              </p>
              <p class="text-xs">
                <span class="text-gray-500 dark:text-gray-400">{{ t('common.total') }}: </span>
                <span class="text-purple-600 dark:text-purple-400" :title="t('usage.actualDeduction')">${{ formatCost(stats?.total_actual_cost || 0) }}</span>
              </p>
            </div>
          </div>
        </div>
...
import { StaggerContainer, GlowCard, AnimatedNumber } from '@/components/animations'
