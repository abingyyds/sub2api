    ...
    <FadeIn>
      <div class="mx-auto max-w-6xl space-y-8">
        ...
        <template v-if="!loading">
          ...
          <!-- Recharge Plans -->
          <StaggerContainer v-if="rechargePlans.length > 0" :stagger-delay="100" :delay="300">
          ...
          <StaggerContainer v-if="decoratedPlans.length > 0" :stagger-delay="120" :delay="450">
...
const planDecoZh: Record<string, Omit<DecoratedPlan, 'plan'>> = {
  '29900': {
    ...
    highlight: '总额$900：官方价格体系，无需复杂换算',
    features: [
      '<strong class="text-gray-900 dark:text-white">每日 $30 高速配额：</strong>专属通道，响应丝滑无卡顿',
      '<strong class="text-gray-900 dark:text-white">总额 $900/月：</strong>充足算力，轻松覆盖日常开发',
  ...
  '58900': {
    ...
    highlight: '折合 $1=¥0.33，立省 67% 成本！',
    features: [
      '<strong class="text-gray-900 dark:text-white text-base">总额 $1,800：</strong>充足算力储备，应对高频调用',
  ...
  '118900': {
    ...
    highlight: '总额$3,600：顶配储备，支撑海量高并发接入',
    features: [
      '<strong class="text-gray-900 dark:text-white">总额 $3,600/月：</strong>顶配算力，满足团队级高频需求',
