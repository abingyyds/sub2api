            ...
            <div class="card overflow-hidden">
              <div class="bg-gradient-to-br from-primary-500 to-primary-600 px-6 py-8 text-center">
                ...
                <p class="mt-2 text-4xl font-bold text-white">
                  $<AnimatedNumber :value="user?.balance || 0" :decimals="2" />
                </p>
                <p class="mt-2 text-sm text-primary-100">
                  {{ t('redeem.concurrency') }}: <AnimatedNumber :value="user?.concurrency || 0" /> {{ t('redeem.requests') }}
                </p>
              </div>
            </div>
          </GlowCard>
                ...
                <form @submit.prevent="handleRedeem" class="space-y-5">
                  <div>
                    ...
                    <div class="relative mt-1">
                      ...
                      <input
                        ...
                        :disabled="submitting"
                        class="input py-3 pl-12 text-lg transition-all duration-300 focus:ring-2 focus:ring-primary-500"
                      />
                    </div>
                    <p class="input-hint">
                  ...
                  <MagneticButton>
                    <button
                      ...
                      class="btn btn-primary w-full py-3 transition-all duration-300"
                    >
                      <svg
                        v-if="submitting"
...
import { FadeIn, SlideIn, GlowCard, MagneticButton, AnimatedNumber } from '@/components/animations'
