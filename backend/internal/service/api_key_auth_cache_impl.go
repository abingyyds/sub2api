...
func (s *APIKeyService) snapshotFromAPIKey(apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			QuotaPackageEnabled:      apiKey.Group.QuotaPackageEnabled,
			QuotaPackageQuotaUSD:     apiKey.Group.QuotaPackageQuotaUSD,
			QuotaPackageValidityDays: apiKey.Group.QuotaPackageValidityDays,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			QuotaPackageEnabled:      snapshot.Group.QuotaPackageEnabled,
			QuotaPackageQuotaUSD:     snapshot.Group.QuotaPackageQuotaUSD,
			QuotaPackageValidityDays: snapshot.Group.QuotaPackageValidityDays,
