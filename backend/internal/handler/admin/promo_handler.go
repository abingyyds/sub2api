...
type CreatePromoCodeRequest struct {
	...
	DiscountAmount float64 `json:"discount_amount" binding:"required,min=0"`  // 折扣值
	DiscountType   string  `json:"discount_type"`                             // "fixed" 或 "percentage"，默认 "fixed"
	MinOrderAmount int     `json:"min_order_amount" binding:"min=0"`          // 满减门槛（分），0=无门槛
...
type UpdatePromoCodeRequest struct {
	...
	MinOrderAmount *int     `json:"min_order_amount" binding:"omitempty,min=0"`
