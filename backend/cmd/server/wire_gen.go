...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	orgMemberHandler := org.NewMemberHandler(orgMemberService)
	orgProjectHandler := org.NewProjectHandler(orgProjectService)
	orgAuditLogHandler := org.NewAuditLogHandler(orgAuditService)
	orgHandlers := handler.ProvideOrgHandlers(orgDashboardHandler, orgMemberHandler, orgProjectHandler, orgAuditLogHandler)
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, adminHandlers, orgHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, modelPlazaHandler, referralHandler, announcementHandler)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, orgAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, redisClient)
