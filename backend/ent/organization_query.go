...
type OrganizationQuery struct {
	...
	withSubscriptions *OrgSubscriptionQuery
	withAPIKeys       *APIKeyQuery
	withProjects      *OrgProjectQuery
	withAuditLogs     *OrgAuditLogQuery
...
func (_q *OrganizationQuery) QueryMembers() *OrgMemberQuery {
	query := (&OrgMemberClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *OrganizationQuery) QuerySubscriptions() *OrgSubscriptionQuery {
...
func (_q *OrganizationQuery) QueryProjects() *OrgProjectQuery {
...
func (_q *OrganizationQuery) QueryAuditLogs() *OrgAuditLogQuery {
	query := (&OrgAuditLogClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *OrganizationQuery) WithMembers(opts ...func(*OrgMemberQuery)) *OrganizationQuery {
	query := (&OrgMemberClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *OrganizationQuery) WithSubscriptions(opts ...func(*OrgSubscriptionQuery)) *OrganizationQuery {
	query := (&OrgSubscriptionClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *OrganizationQuery) WithProjects(opts ...func(*OrgProjectQuery)) *OrganizationQuery {
	query := (&OrgProjectClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *OrganizationQuery) WithAuditLogs(opts ...func(*OrgAuditLogQuery)) *OrganizationQuery {
	query := (&OrgAuditLogClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *OrganizationQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Organization, error) {
	...
	if query := _q.withSubscriptions; query != nil {
		if err := _q.loadSubscriptions(ctx, query, nodes,
			func(n *Organization) { n.Edges.Subscriptions = []*OrgSubscription{} },
			func(n *Organization, e *OrgSubscription) { n.Edges.Subscriptions = append(n.Edges.Subscriptions, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withProjects; query != nil {
		if err := _q.loadProjects(ctx, query, nodes,
			func(n *Organization) { n.Edges.Projects = []*OrgProject{} },
			func(n *Organization, e *OrgProject) { n.Edges.Projects = append(n.Edges.Projects, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withAuditLogs; query != nil {
		if err := _q.loadAuditLogs(ctx, query, nodes,
			func(n *Organization) { n.Edges.AuditLogs = []*OrgAuditLog{} },
			func(n *Organization, e *OrgAuditLog) { n.Edges.AuditLogs = append(n.Edges.AuditLogs, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *OrganizationQuery) loadMembers(ctx context.Context, query *OrgMemberQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *OrgMember)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(orgmember.FieldOrgID)
	}
...
func (_q *OrganizationQuery) loadSubscriptions(ctx context.Context, query *OrgSubscriptionQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *OrgSubscription)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Organization)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(orgsubscription.FieldOrgID)
	}
...
func (_q *OrganizationQuery) loadAPIKeys(ctx context.Context, query *APIKeyQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *APIKey)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(apikey.FieldOrgID)
	}
...
func (_q *OrganizationQuery) loadProjects(ctx context.Context, query *OrgProjectQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *OrgProject)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Organization)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(orgproject.FieldOrgID)
	}
...
func (_q *OrganizationQuery) loadAuditLogs(ctx context.Context, query *OrgAuditLogQuery, nodes []*Organization, init func(*Organization), assign func(*Organization, *OrgAuditLog)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Organization)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.OrgAuditLog(func(s *sql.Selector) {
	...
	for _, n := range neighbors {
		fk := n.organization_audit_logs
		if fk == nil {
			return fmt.Errorf(`foreign-key "organization_audit_logs" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "organization_audit_logs" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
