...
const (
	// Label holds the string label denoting the orgproject type in the database.
	Label = "org_project"
	...
	// Table holds the table name of the orgproject in the database.
	Table = "org_projects"
	// OrganizationTable is the table that holds the organization relation/edge.
	OrganizationTable = "org_projects"
	...
	APIKeysColumn = "org_project_id"
)

// Columns holds all SQL columns for orgproject fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the OrgProject queries.
