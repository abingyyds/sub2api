...
# Install pnpm. Keep this pinned so Docker builds are not affected by new pnpm
# defaults such as build-script approvals.
...
# Allow go generate to update go.mod automatically
ENV GOFLAGS="-mod=mod"
